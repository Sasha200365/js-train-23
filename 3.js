...
class BlackTeaMaker extends TeaMaker {
  ...
  addCondiments() {
    console.log("Додаємо молоко та цукор, щоб приготувати чорний чай..."); // прийшлося виправити молоко та цукор, замість мед
  }
}
...
greenTeaMaker.makeTea(); // прийшлося виправити метод prepareTea на makeTae

const blackTeaMaker = new BlackTeaMaker();
blackTeaMaker.makeTea(); // прийшлося виправити метод prepareTea на makeTae
